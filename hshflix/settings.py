"""
Django settings for hshflix project.
...
SECRET_KEY = 'django-insecure-+ithmr0l22vx22fi!v_j0a(g#8ujh$)_1-@ou@gzf$6sloujg+'
...
WSGI_APPLICATION = 'hshflix.wsgi.application'
